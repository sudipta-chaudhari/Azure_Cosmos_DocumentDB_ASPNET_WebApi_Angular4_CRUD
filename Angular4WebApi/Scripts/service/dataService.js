...
var InventoryService = (function () {
    ...
    InventoryService.prototype.getAllProducts = function () {
        ...
        return this.http.get('/api/Product/GetProductsAsync').map(function (res) { return res.json(); });
    };
    InventoryService.prototype.addProduct = function (product) {
        ...
        return this.http.post('/api/Product/CreateItemAsync', body, options).map(function (res) { return res.json(); });
    };
    ...
    //    return this.http.post('/api/Product/UpdateProduct', body, options).map((res: Response) => res.json());
    //}
    InventoryService.prototype.updateProduct = function (product) {
        ...
        var body = JSON.stringify(product);
        //return this.http.put('/api/Product/' + product.Id, body, options).map((res: Response) => res.json());
        return this.http.post('api/Product/UpdateItemAsync/?id=' + product.id, body, options).map(function (res) { return res.json(); });
    };
    //deleteProduct(product) {
    //    return this.http.delete('/api/Product/' + product.Id);
    //}
    InventoryService.prototype.deleteProduct = function (id) {
